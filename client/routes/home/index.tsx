        ...
        <div className="flex justify-center">
          <div className="xl:w-4/5">
            ...
            <p>
              ...
              encouraged to try one of the frameworks or game engines that make use of LWJGL, before working directly
              with the library.
            </p>
          ...
          <div className="row">
            ...
            <div className="col-md py-3">
              ...
              <p>
                ...
                consoles, phones, appliances and vehicles. It consists of well-defined subsets of desktop OpenGL,
                creating a flexible and powerful low-level interface between software and graphics acceleration.
              </p>
            </div>
            <div className="col-md py-3">
